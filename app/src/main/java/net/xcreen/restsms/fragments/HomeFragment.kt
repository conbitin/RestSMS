...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        toggleServerBtn!!.setOnClickListener { v ->
            ...
            if (ActivityCompat.checkSelfPermission(v.context, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.checkSelfPermission(v.context, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.checkSelfPermission(v.context, Manifest.permission.RECEIVE_SMS) != PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.checkSelfPermission(v.context, Manifest.permission.RECEIVE_MMS) != PackageManager.PERMISSION_GRANTED
            ) { //Show Error Toast
            ...
            if (ServerService.isRunning) {
                ...
                if (sharedPref.getBoolean("open_browser_serverstart", false)) { //Wait till Server is started
                    Thread(Runnable {
